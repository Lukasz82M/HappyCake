...
import de.syntaxinstitut.happycake.databinding.FragmentCheckOutBinding
...
class CheckOutFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener { findNavController().navigate(CheckOutFragmentDirections.actionCheckOutFragmentToGoodbyeFragment())}
    }
